...
export type EditTitleMutation = {
  __typename?: 'Mutation', updateMysqlTitle: {
    __typename?: 'UpdateMysqlTitlePayload', titles?: { __typename?: 'Titles', endYear?: number | null, isAdult: boolean, originalTitle: string, primaryTitle: string, runtimeMinutes?: number | null, startYear: number, titleId: string, titleType: string } | null, errors?: Array<
