    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    attribute_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    genre_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    logging_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
                    table_name = table.Column<byte[]>(type: "BINARY(16)", maxLength: 100, nullable: false),
                    ...
                    executed_by = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, collation: "utf8mb3_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb3"),
                    executed_at = table.Column<DateTime>(type: "datetime(6)", maxLength: 6, nullable: false, defaultValueSql: "now(6)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    person_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
                    name = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false, collation: "utf8mb3_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb3"),
                    birth_year = table.Column<short>(type: "year", nullable: false),
                    end_year = table.Column<short>(type: "year", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    title_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
                    ...
                    start_year = table.Column<short>(type: "year", nullable: false),
                    end_year = table.Column<short>(type: "year", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    type_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    profession_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
                    person_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Titles_title_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    Persons_person_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    Role = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false, collation: "utf8mb3_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb3")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    alias_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
                    title_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    comment_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
                    title_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    episode_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
                    title_id_parent = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    title_id_child = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    rating_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false, defaultValueSql: "(uuid_to_bin(uuid(),1))"),
                    title_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Titles_title_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    Genres_genre_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Aliases_alias_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    Attributes_attribute_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Aliases_alias_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    Types_type_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false)
                },
                constraints: table =>
                {
