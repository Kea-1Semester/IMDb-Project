...
CREATE TABLE IF NOT EXISTS `imdb`.`Persons` (
  `person_id` BINARY(16) NOT NULL DEFAULT (uuid_to_bin(uuid(),1)),
...
CREATE TABLE IF NOT EXISTS `imdb`.`Titles` (
  `title_id` BINARY(16) NOT NULL DEFAULT (uuid_to_bin(uuid(),1)),
...
CREATE TABLE IF NOT EXISTS `imdb`.`Actors` (
  `actor_id` BINARY(16) NOT NULL DEFAULT (uuid_to_bin(uuid(),1)),
