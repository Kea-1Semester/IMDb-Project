...
public class AuthorizationPages : PageTest
{
    ...
    public async Task Test_Login()
    {
        ...
        var mailInput = Environment.GetEnvironmentVariable("TEST_USER_EMAIL") ?? "test@test.dk";
        ...
        var submitButton = Page.Locator("button.c04b3dedf.c837aaff8.cea427a68.cfb672822.cdda8fe19",
            new PageLocatorOptions { HasTextString = "Continue" });
