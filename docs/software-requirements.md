...
The purpose of the IMDB dataset application is to provide a user interface for the IMDb dataset.
This will allow users to engage with the interface for exploring and interacting with movies.
This SRS will serve as the foundation for the later system design and development phases.

**Description**: 

The application will consist of a **backend** for data handling and a **frontend** for user interaction. Users will be able to search and view for movie or TV show details, view detailed information and be able to comment and rate movies.
